...
export { fakerAF_ZA, fakerAR, fakerAZ, fakerBASE, fakerCS_CZ, fakerDE, fakerDE_AT, fakerDE_CH, fakerDV, fakerEL, fakerEN, fakerEN_AU, fakerEN_AU_ocker, fakerEN_BORK, fakerEN_CA, fakerEN_GB, fakerEN_GH, fakerEN_HK, fakerEN_IE, fakerEN_IN, fakerEN_NG, fakerEN_US, fakerEN_ZA, fakerES, fakerES_MX, fakerFA, fakerFI, fakerFR, fakerFR_BE, fakerFR_CA, fakerFR_CH, fakerFR_LU, fakerHE, fakerHR, fakerHU, fakerHY, fakerID_ID, fakerIT, fakerJA, fakerKA_GE, fakerKO, fakerLV, fakerMK, fakerNB_NO, fakerNE, fakerNL, fakerNL_BE, fakerPL, fakerPT_BR, fakerPT_PT, fakerRO, fakerRO_MD, fakerRU, fakerSK, fakerSR_RS_latin, fakerSV, fakerTH, fakerTR, fakerUK, fakerUR, fakerVI, fakerZH_CN, fakerZH_TW, fakerZU_ZA, };
export declare const allFakers: {
    readonly af_ZA: import("@faker-js/faker").Faker;
    readonly ar: import("@faker-js/faker").Faker;
    readonly az: import("@faker-js/faker").Faker;
    readonly base: import("@faker-js/faker").Faker;
    readonly cs_CZ: import("@faker-js/faker").Faker;
    readonly de: import("@faker-js/faker").Faker;
    readonly de_AT: import("@faker-js/faker").Faker;
    readonly de_CH: import("@faker-js/faker").Faker;
    readonly dv: import("@faker-js/faker").Faker;
    readonly el: import("@faker-js/faker").Faker;
    readonly en: import("@faker-js/faker").Faker;
    readonly en_AU: import("@faker-js/faker").Faker;
    readonly en_AU_ocker: import("@faker-js/faker").Faker;
    readonly en_BORK: import("@faker-js/faker").Faker;
    readonly en_CA: import("@faker-js/faker").Faker;
    readonly en_GB: import("@faker-js/faker").Faker;
    readonly en_GH: import("@faker-js/faker").Faker;
    readonly en_HK: import("@faker-js/faker").Faker;
    readonly en_IE: import("@faker-js/faker").Faker;
    readonly en_IN: import("@faker-js/faker").Faker;
    readonly en_NG: import("@faker-js/faker").Faker;
    readonly en_US: import("@faker-js/faker").Faker;
    readonly en_ZA: import("@faker-js/faker").Faker;
    readonly es: import("@faker-js/faker").Faker;
    readonly es_MX: import("@faker-js/faker").Faker;
    readonly fa: import("@faker-js/faker").Faker;
    readonly fi: import("@faker-js/faker").Faker;
    readonly fr: import("@faker-js/faker").Faker;
    readonly fr_BE: import("@faker-js/faker").Faker;
    readonly fr_CA: import("@faker-js/faker").Faker;
    readonly fr_CH: import("@faker-js/faker").Faker;
    readonly fr_LU: import("@faker-js/faker").Faker;
    readonly he: import("@faker-js/faker").Faker;
    readonly hr: import("@faker-js/faker").Faker;
    readonly hu: import("@faker-js/faker").Faker;
    readonly hy: import("@faker-js/faker").Faker;
    readonly id_ID: import("@faker-js/faker").Faker;
    readonly it: import("@faker-js/faker").Faker;
    readonly ja: import("@faker-js/faker").Faker;
    readonly ka_GE: import("@faker-js/faker").Faker;
    readonly ko: import("@faker-js/faker").Faker;
    readonly lv: import("@faker-js/faker").Faker;
    readonly mk: import("@faker-js/faker").Faker;
    readonly nb_NO: import("@faker-js/faker").Faker;
    readonly ne: import("@faker-js/faker").Faker;
    readonly nl: import("@faker-js/faker").Faker;
    readonly nl_BE: import("@faker-js/faker").Faker;
    readonly pl: import("@faker-js/faker").Faker;
    readonly pt_BR: import("@faker-js/faker").Faker;
    readonly pt_PT: import("@faker-js/faker").Faker;
    readonly ro: import("@faker-js/faker").Faker;
    readonly ro_MD: import("@faker-js/faker").Faker;
    readonly ru: import("@faker-js/faker").Faker;
    readonly sk: import("@faker-js/faker").Faker;
    readonly sr_RS_latin: import("@faker-js/faker").Faker;
    readonly sv: import("@faker-js/faker").Faker;
    readonly th: import("@faker-js/faker").Faker;
    readonly tr: import("@faker-js/faker").Faker;
    readonly uk: import("@faker-js/faker").Faker;
    readonly ur: import("@faker-js/faker").Faker;
    readonly vi: import("@faker-js/faker").Faker;
    readonly zh_CN: import("@faker-js/faker").Faker;
    readonly zh_TW: import("@faker-js/faker").Faker;
    readonly zu_ZA: import("@faker-js/faker").Faker;
};
